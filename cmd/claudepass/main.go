// Package main is the CLI entry point for the claudepass proxy server.
package main
...
import (
	...
	"claudepass/internal/daemon"
	"claudepass/internal/server"
)

const (
	appName     = "claudepass"
	pidFileName = "claudepass.pid"
)
...
func serveCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if configPath != "" {
				_ = os.Setenv("CLAUDEPASS_CONFIG", configPath)
			}
...
func getConfigDir() string {
	...
	return filepath.Join(home, ".config", "claudepass")
}
